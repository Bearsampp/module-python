...
_pkg_config = {
    'pyqt_bin_dir':      'X:\\Python34-x32',
    'pyqt_config_args':  '-w --confirm-license',
    'pyqt_mod_dir':      'X:\\Python34-x32\\Lib\\site-packages\\PyQt4',
    ...
    'pyqt_sip_dir':      'X:\\Python34-x32\\sip\\PyQt4',
    'pyqt_sip_flags':    '-x VendorID -t WS_WIN -x PyQt_NoPrintRangeBug -t Qt_4_8_6 -g',
    'pyqt_version':      0x040b04,
    'pyqt_version_str':  '4.11.4',
    'qt_archdata_dir':   'X:\\Qt487-vc10-x32',
    'qt_data_dir':       'X:\\Qt487-vc10-x32',
    'qt_dir':            'X:\\Qt487-vc10-x32',
    'qt_edition':        'free',
    'qt_framework':      0,
    'qt_inc_dir':        'X:\\Qt487-vc10-x32\\include',
    'qt_lib_dir':        'X:\\Qt487-vc10-x32\\lib',
    'qt_threaded':       1,
    'qt_version':        0x040807,
    'qt_winconfig':      'shared'
}
...
_default_macros = {
    ...
    'INCDIR':                   '',
    'INCDIR_OPENGL':            '',
    'INCDIR_QT':                'X:\\Qt487-vc10-x32\\include',
    'INCDIR_X11':               '',
    ...
    'LIBDIR':                   '',
    'LIBDIR_OPENGL':            '',
    'LIBDIR_QT':                'X:\\Qt487-vc10-x32\\lib',
    'LIBDIR_X11':               '',
    'LIBS':                     '',
    'LIBS_CONSOLE':             '',
    ...
    'MKDIR':                    'mkdir',
    'MOC':                      'X:\\Qt487-vc10-x32\\bin\\\\moc.exe',
    'RANLIB':                   '',
    'RPATH':                    '',
    'STRIP':                    ''
}
