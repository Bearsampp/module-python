...
_pkg_config = {
    'arch':               '',
    'default_bin_dir':    'X:\\Python34-x32',
    'default_mod_dir':    'X:\\Python34-x32\\Lib\\site-packages',
    'default_sip_dir':    'X:\\Python34-x32\\sip',
    'deployment_target':  '',
    'platform':           'win32-msvc2010',
    'py_conf_inc_dir':    'X:\\Python34-x32\\include',
    'py_inc_dir':         'X:\\Python34-x32\\include',
    'py_lib_dir':         'X:\\Python34-x32\\libs',
    'py_version':         0x030403,
    'qt_framework':       0,
    'sip_bin':            'X:\\Python34-x32\\sip',
    'sip_config_args':    '-p win32-msvc2010',
    'sip_inc_dir':        'X:\\Python34-x32\\include',
    'sip_mod_dir':        'X:\\Python34-x32\\Lib\\site-packages',
