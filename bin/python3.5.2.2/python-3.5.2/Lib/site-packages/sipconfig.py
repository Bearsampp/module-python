...
_pkg_config = {
    'arch':               '',
    'default_bin_dir':    'X:\\Python35-x32',
    'default_mod_dir':    'X:\\Python35-x32\\Lib\\site-packages',
    'default_sip_dir':    'X:\\Python35-x32\\sip',
    'deployment_target':  '',
    'platform':           'win32-msvc2015',
    'py_conf_inc_dir':    'X:\\Python35-x32\\include',
    'py_inc_dir':         'X:\\Python35-x32\\include',
    'py_lib_dir':         'X:\\Python35-x32\\libs',
    'py_version':         0x030500,
    'qt_framework':       0,
    'sip_bin':            'X:\\Python35-x32\\sip',
    'sip_config_args':    '-p win32-msvc2015',
    'sip_inc_dir':        'X:\\Python35-x32\\include',
    'sip_mod_dir':        'X:\\Python35-x32\\Lib\\site-packages',
